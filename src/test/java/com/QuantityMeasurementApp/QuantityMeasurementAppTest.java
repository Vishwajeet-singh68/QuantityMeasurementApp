...
public class QuantityMeasurementAppTest {
    ...
    public void weightKilogramEqualsGrams() {
        Quantity<WeightUnit> kg = new Quantity<>(1.0, WeightUnit.KILOGRAMS);
    ...
    public void weightPoundEqualsGrams() {
        Quantity<WeightUnit> pound = new Quantity<>(1.0, WeightUnit.POUNDS);
    ...
    public void convertLengthFeetToInches() {
        Quantity<LengthUnit> feet = new Quantity<>(1.0, LengthUnit.FEET);
        double inches = feet.convertTo(LengthUnit.INCHES).getValue();
    ...
    public void convertLengthYardsToInches() {
        Quantity<LengthUnit> yard = new Quantity<>(1.0, LengthUnit.YARD);
        double inches = yard.convertTo(LengthUnit.INCHES).getValue();
    ...
    public void convertWeightKilogramsToGrams() {
        Quantity<WeightUnit> kg = new Quantity<>(1.0, WeightUnit.KILOGRAMS);
        double grams = kg.convertTo(WeightUnit.GRAMS).getValue();
    ...
    public void addWeightKilogramsAndGrams() {
        Quantity<WeightUnit> kg = new Quantity<>(1.0, WeightUnit.KILOGRAMS);
        Quantity<WeightUnit> grams = new Quantity<>(500.0, WeightUnit.GRAMS);
    ...
    public void testGenericTypeSafetyWithWeight() {
        Quantity<WeightUnit> w = new Quantity<>(1.0, WeightUnit.KILOGRAMS);
        assertNotNull(w);
    ...
    public void preventCrossTypeComparisonLengthVsWeight() {
        ...
        Quantity<WeightUnit> weight = new Quantity<>(1.0, WeightUnit.KILOGRAMS);
    ...
    void testValidation_CrossCategory_ConsistentAcrossOperations() {
        ...
        Quantity<WeightUnit> weight = new Quantity<>(5.0, WeightUnit.KILOGRAMS);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> length.division((Quantity) weight));
    }
